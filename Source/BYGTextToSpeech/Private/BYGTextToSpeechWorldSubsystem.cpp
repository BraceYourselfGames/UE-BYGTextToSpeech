...
#include "BYGTextToSpeechWorldSubsystem.h"
...
UBYGTextToSpeechWorldSubsystem::UBYGTextToSpeechWorldSubsystem()
	: TickFunction( this )
{
...
void UBYGTextToSpeechWorldSubsystem::Initialize(FSubsystemCollectionBase& Collection)
{
	// Register Tick 
...
void UBYGTextToSpeechWorldSubsystem::Deinitialize()
{
	TickFunction.UnRegisterTickFunction();
	//Proxies.Empty();
}

void UBYGTextToSpeechWorldSubsystem::Tick( float DeltaTime, enum ELevelTick TickType, ENamedThreads::Type CurrentThread, const FGraphEventRef& MyCompletionGraphEvent )
//void UBYGTextToSpeechWorldSubsystem::Tick( float DeltaTime )
{
...
//void UBYGTextToSpeechWorldSubsystem::AddReferencedObjects( FReferenceCollector& Collector )
//{
...
bool UBYGTextToSpeechWorldSubsystem::SetVoiceId( const FString& InVoiceId )
{
...
void UBYGTextToSpeechWorldSubsystem::ReadTextUnderCursor()
{

}

void UBYGTextToSpeechWorldSubsystem::StopAudio()
{
	if ( AudioComponent )
	{
		AudioComponent->Stop();
...
void UBYGTextToSpeechWorldSubsystem::SetIsEnabled( bool bInIsEnabled )
{
